...
search = function(api_key = "eca7388c8a3c6332eb702a21bcc63b46",
                  lang = "en", area, pref, areacode_l,
                          ...
                          min_num_pics = 5,
                          verbose = F) {
        # Searches for Gurunavi listings by location.
        # Returns a named list containing various search outputs.
        #
        ...
        # checkout     : string, check out date of format "yyyy-mm-dd".
        # guests       : integer, number of guests, default = 1.
        # min_bathrooms: numeric, min number of bathrooms, default = 1.
        # min_bedrooms : integer, min number of bedrooms, default = 1.
        # price_min    : integer, min price (USD) per night, default = 0.
        # price_max    : integer, max price (USD) per night, default = 25.
        # min_num_pics : integer, min number of pictures, default = 5.
        # verbose      : boolean, T/F, indicating whether to print status updates

        # default search parameters
        params = list(keyid = api_key,
                      format = "json",
                      lang = lang,
                      # "amenities[]" = 1,
                      ...
                      "_limit" = 1,
                      "_offset" = 0)
        api_url = "https://api.gnavi.co.jp/ForeignRestSearchAPI/20150630/?"
